...
`,[g("strong",`
 ...
 `)]),R=Object.assign(Object.assign({},b.props),{code:Boolean,type:{type:String,default:"default"},delete:Boolean,strong:Boolean,italic:Boolean,underline:Boolean,depth:[String,Number],tag:String,as:{type:String,validator:()=>!0,default:void 0}}),V=S({name:"Text",props:R,setup(t){const{mergedClsPrefixRef:r,inlineThemeDisabled:o}=z(t),i=b("Typography","-text",D,$,t,r),a=f(()=>{const{depth:l,type:d}=t,u=d==="default"?l===void 0?"textColor":`textColor${l}Depth`:W("textColor",d),{common:{fontWeightStrong:n,fontFamilyMono:s,cubicBezierEaseInOut:c},self:{codeTextColor:h,codeBorderRadius:x,codeColor:p,codeBorder:m,[u]:v}}=i.value;return{"--n-bezier":c,"--n-text-color":v,"--n-font-weight-strong":n,"--n-font-famliy-mono":s,"--n-code-border-radius":x,"--n-code-text-color":h,"--n-code-color":p,"--n-code-border":m}}),e=o?T("text",f(()=>`${t.type[0]}${t.depth||""}`),a,t):void 0;return{mergedClsPrefix:r,compitableTag:P(t,["as","tag"]),cssVars:o?void 0:a,themeClass:e==null?void 0:e.themeClass,onRender:e==null?void 0:e.onRender}},render(){var t,r,o;const{mergedClsPrefix:i}=this;(t=this.onRender)===null||t===void 0||t.call(this);const a=[`${i}-text`,this.themeClass,{[`${i}-text--code`]:this.code,[`${i}-text--delete`]:this.delete,[`${i}-text--strong`]:this.strong,[`${i}-text--italic`]:this.italic,[`${i}-text--underline`]:this.underline}],e=(o=(r=this.$slots).default)===null||o===void 0?void 0:o.call(r);return this.code?C("code",{class:a,style:this.cssVars},this.delete?C("del",null,e):e):this.delete?C("del",{class:a,style:this.cssVars},e):C(this.compitableTag||"span",{class:a,style:this.cssVars},e)}});export{V as _};
