import{g as c,o as x,n as v,d as M,h as l,u as qe,a1 as st,c as ut,a4 as dt,a as ct,ay as W,az as H,aA as be,aB as T,aC as O,aD as L,aE as oe,aF as J,aG as Ee,aH as Ue,aI as D,aJ as Ae,aK as Re,m as R,r as $,aL as ne,aM as ae,f as ht,q as Ne,D as Oe,aN as se,aO as $e,aP as ze,aQ as Ve,aR as pt,ar as ft,i as Ie,aS as gt,al as mt,ap as bt,aq as vt,as as xt,j as Le,aa as kt,l as wt,ax as Be,au as yt,t as he,W as pe,aw as St,v as Ce,ai as Fe,p as Ct}from"./index-C-GNn6E_.js";import{i as Ut,_ as At}from"./Input-BCz37wum.js";import{V as Rt,a as $t,u as _e,B as zt}from"./Popover-q_XieIzg.js";import{b as Vt}from"./request-B0YgnReI.js";import{u as He}from"./get-DHXohDMp.js";const _t=c("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
...
`,[x(">",[c("input",[x("&:not(:last-child)",`
 ...
 filter: blur(2px);
 content: "";
 `)])])])])]),lr=Object.assign(Object.assign({},Le.props),{value:String,show:{type:Boolean,default:void 0},defaultShow:Boolean,defaultValue:String,modes:{type:Array,default:()=>["rgb","hex","hsl"]},placement:{type:String,default:"bottom-start"},to:_e.propTo,showAlpha:{type:Boolean,default:!0},showPreview:Boolean,swatches:Array,disabled:{type:Boolean,default:void 0},actions:{type:Array,default:null},internalActions:Array,size:String,renderLabel:Function,onComplete:Function,onConfirm:Function,onClear:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),pr=M({name:"ColorPicker",props:lr,slots:Object,setup(e,{slots:t}){let i=null;function o(r){i=r}let a=null;const{mergedClsPrefixRef:n,namespaceRef:s,inlineThemeDisabled:u,mergedComponentPropsRef:f}=qe(e),w=xt(e,{mergedSize:r=>{var d,h;const{size:g}=e;if(g)return g;const{mergedSize:m}=r||{};if(m!=null&&m.value)return m.value;const p=(h=(d=f==null?void 0:f.value)===null||d===void 0?void 0:d.ColorPicker)===null||h===void 0?void 0:h.size;return p||"medium"}}),{mergedSizeRef:I,mergedDisabledRef:z}=w,{localeRef:V}=Vt("global"),_=Le("ColorPicker","-color-picker",ir,It,e,n);Ct(Pe,{themeRef:_,renderLabelRef:Ce(e,"renderLabel"),colorPickerSlots:t});const j=$(e.defaultShow),ve=He(Ce(e,"show"),j);function de(r){const{onUpdateShow:d,"onUpdate:show":h}=e;d&&he(d,r),h&&he(h,r),j.value=r}const{defaultValue:De}=e,Me=$(De===void 0?Bt(e.modes,e.showAlpha):De),y=He(Ce(e,"value"),Me),Q=$([y.value]),B=$(0),xe=R(()=>ue(y.value)),{modes:Ge}=e,P=$(ue(y.value)||Ge[0]||"rgb");function Ke(){const{modes:r}=e,{value:d}=P,h=r.findIndex(g=>g===d);~h?P.value=r[(h+1)%r.length]:P.value="rgb"}let C,U,Y,ee,q,E,N,A;const ie=R(()=>{const{value:r}=y;if(!r)return null;switch(xe.value){case"hsv":return W(r);case"hsl":return[C,U,Y,A]=oe(r),[...Ee(C,U,Y),A];case"rgb":case"hex":return[q,E,N,A]=D(r),[...Ae(q,E,N),A]}}),G=R(()=>{const{value:r}=y;if(!r)return null;switch(xe.value){case"rgb":case"hex":return D(r);case"hsv":return[C,U,ee,A]=W(r),[...O(C,U,ee),A];case"hsl":return[C,U,Y,A]=oe(r),[...Ue(C,U,Y),A]}}),ke=R(()=>{const{value:r}=y;if(!r)return null;switch(xe.value){case"hsl":return oe(r);case"hsv":return[C,U,ee,A]=W(r),[...be(C,U,ee),A];case"rgb":case"hex":return[q,E,N,A]=D(r),[...Re(q,E,N),A]}}),Xe=R(()=>{switch(P.value){case"rgb":case"hex":return G.value;case"hsv":return ie.value;case"hsl":return ke.value}}),ce=$(0),we=$(1),ye=$([0,0]);function Ze(r,d){const{value:h}=ie,g=ce.value,m=h?h[3]:1;ye.value=[r,d];const{showAlpha:p}=e;switch(P.value){case"hsv":b((p?J:Ve)([g,r,d,m]),"cursor");break;case"hsl":b((p?H:$e)([...be(g,r,d),m]),"cursor");break;case"rgb":b((p?T:ze)([...O(g,r,d),m]),"cursor");break;case"hex":b((p?L:se)([...O(g,r,d),m]),"cursor");break}}function We(r){ce.value=r;const{value:d}=ie;if(!d)return;const[,h,g,m]=d,{showAlpha:p}=e;switch(P.value){case"hsv":b((p?J:Ve)([r,h,g,m]),"cursor");break;case"rgb":b((p?T:ze)([...O(r,h,g),m]),"cursor");break;case"hex":b((p?L:se)([...O(r,h,g),m]),"cursor");break;case"hsl":b((p?H:$e)([...be(r,h,g),m]),"cursor");break}}function Je(r){switch(P.value){case"hsv":[C,U,ee]=ie.value,b(J([C,U,ee,r]),"cursor");break;case"rgb":[q,E,N]=G.value,b(T([q,E,N,r]),"cursor");break;case"hex":[q,E,N]=G.value,b(L([q,E,N,r]),"cursor");break;case"hsl":[C,U,Y]=ke.value,b(H([C,U,Y,r]),"cursor");break}we.value=r}function b(r,d){d==="cursor"?a=r:a=null;const{nTriggerFormChange:h,nTriggerFormInput:g}=w,{onUpdateValue:m,"onUpdate:value":p}=e;m&&he(m,r),p&&he(p,r),h(),g(),Me.value=r}function Qe(r){b(r,"input"),St(te)}function te(r=!0){const{value:d}=y;if(d){const{nTriggerFormChange:h,nTriggerFormInput:g}=w,{onComplete:m}=e;m&&m(d);const{value:p}=Q,{value:S}=B;r&&(p.splice(S+1,p.length,d),B.value=S+1),h(),g()}}function Ye(){const{value:r}=B;r-1<0||(b(Q.value[r-1],"input"),te(!1),B.value=r-1)}function et(){const{value:r}=B;r<0||r+1>=Q.value.length||(b(Q.value[r+1],"input"),te(!1),B.value=r+1)}function tt(){b(null,"input");const{onClear:r}=e;r&&r(),de(!1)}function rt(){const{value:r}=y,{onConfirm:d}=e;d&&d(r),de(!1)}const ot=R(()=>B.value>=1),nt=R(()=>{const{value:r}=Q;return r.length>1&&B.value<r.length-1});kt(ve,r=>{r||(Q.value=[y.value],B.value=0)}),Oe(()=>{if(!(a&&a===y.value)){const{value:r}=ie;r&&(ce.value=r[0],we.value=r[3],ye.value=[r[1],r[2]])}a=null});const Se=R(()=>{const{value:r}=I,{common:{cubicBezierEaseInOut:d},self:{textColor:h,color:g,panelFontSize:m,boxShadow:p,border:S,borderRadius:k,dividerColor:K,[Fe("height",r)]:it,[Fe("fontSize",r)]:lt}}=_.value;return{"--n-bezier":d,"--n-text-color":h,"--n-color":g,"--n-panel-font-size":m,"--n-font-size":lt,"--n-box-shadow":p,"--n-border":S,"--n-border-radius":k,"--n-height":it,"--n-divider-color":K}}),F=u?wt("color-picker",R(()=>I.value[0]),Se,e):void 0;function at(){var r;const{value:d}=G,{value:h}=ce,{internalActions:g,modes:m,actions:p}=e,{value:S}=_,{value:k}=n;return l("div",{class:[`${k}-color-picker-panel`,F==null?void 0:F.themeClass.value],onDragstart:K=>{K.preventDefault()},style:u?void 0:Se.value},l("div",{class:`${k}-color-picker-control`},l(ar,{clsPrefix:k,rgba:d,displayedHue:h,displayedSv:ye.value,onUpdateSV:Ze,onComplete:te}),l("div",{class:`${k}-color-picker-preview`},l("div",{class:`${k}-color-picker-preview__sliders`},l(nr,{clsPrefix:k,hue:h,onUpdateHue:We,onComplete:te}),e.showAlpha?l(Nt,{clsPrefix:k,rgba:d,alpha:we.value,onUpdateAlpha:Je,onComplete:te}):null),e.showPreview?l(er,{clsPrefix:k,mode:P.value,color:G.value&&se(G.value),onUpdateColor:K=>{b(K,"input")}}):null),l(Zt,{clsPrefix:k,showAlpha:e.showAlpha,mode:P.value,modes:m,onUpdateMode:Ke,value:y.value,valueArr:Xe.value,onUpdateValue:Qe}),((r=e.swatches)===null||r===void 0?void 0:r.length)&&l(Qt,{clsPrefix:k,mode:P.value,swatches:e.swatches,onUpdateColor:K=>{b(K,"input")}})),p!=null&&p.length?l("div",{class:`${k}-color-picker-action`},p.includes("confirm")&&l(pe,{size:"small",onClick:rt,theme:S.peers.Button,themeOverrides:S.peerOverrides.Button},{default:()=>V.value.confirm}),p.includes("clear")&&l(pe,{size:"small",onClick:tt,disabled:!y.value,theme:S.peers.Button,themeOverrides:S.peerOverrides.Button},{default:()=>V.value.clear})):null,t.action?l("div",{class:`${k}-color-picker-action`},{default:t.action}):g?l("div",{class:`${k}-color-picker-action`},g.includes("undo")&&l(pe,{size:"small",onClick:Ye,disabled:!ot.value,theme:S.peers.Button,themeOverrides:S.peerOverrides.Button},{default:()=>V.value.undo}),g.includes("redo")&&l(pe,{size:"small",onClick:et,disabled:!nt.value,theme:S.peers.Button,themeOverrides:S.peerOverrides.Button},{default:()=>V.value.redo})):null)}return{mergedClsPrefix:n,namespace:s,hsla:ke,rgba:G,mergedShow:ve,mergedDisabled:z,isMounted:yt(),adjustedTo:_e(e),mergedValue:y,handleTriggerClick(){z.value||de(!0)},setTriggerRef:o,handleClickOutside(r){if(i instanceof Element){if(i.contains(Be(r)))return}else if(i&&i.$el.contains(Be(r)))return;de(!1)},renderPanel:at,cssVars:u?void 0:Se,themeClass:F==null?void 0:F.themeClass,onRender:F==null?void 0:F.onRender}},render(){const{mergedClsPrefix:e,onRender:t}=this;return t==null||t(),l(zt,null,{default:()=>[l(Rt,null,{default:()=>gt(this.$slots.trigger,{value:this.mergedValue,onClick:this.handleTriggerClick,ref:this.setTriggerRef},i=>i||l(Yt,{clsPrefix:e,value:this.mergedValue,hsla:this.hsla,style:this.cssVars,ref:this.setTriggerRef,disabled:this.mergedDisabled,class:this.themeClass,onClick:this.mergedDisabled?void 0:this.handleTriggerClick}))}),l($t,{placement:this.placement,show:this.mergedShow,containerClass:this.namespace,teleportDisabled:this.adjustedTo===_e.tdkey,to:this.adjustedTo},{default:()=>l(mt,{name:"fade-in-scale-up-transition",appear:this.isMounted},{default:()=>this.mergedShow?bt(this.renderPanel(),[[vt,this.handleClickOutside,void 0,{capture:!0}]]):null})})]})}});export{pr as _};
